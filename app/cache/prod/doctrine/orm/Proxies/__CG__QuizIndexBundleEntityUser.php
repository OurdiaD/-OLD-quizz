 ...
 */
class User extends \Quiz\IndexBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Quiz\\IndexBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Quiz\\IndexBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Quiz\\IndexBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Quiz\\IndexBundle\\Entity\\User' . "\0" . 'mail', '' . "\0" . 'Quiz\\IndexBundle\\Entity\\User' . "\0" . 'activate', '' . "\0" . 'Quiz\\IndexBundle\\Entity\\User' . "\0" . 'ip', '' . "\0" . 'Quiz\\IndexBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'Quiz\\IndexBundle\\Entity\\User' . "\0" . 'roles'];
        }
    ...
    public function setUsernane($usernane)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUsernane', [$usernane]);

        return parent::setUsernane($usernane);
    }
    ...
    public function getUsernane()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUsernane', []);

        return parent::getUsernane();
    }
